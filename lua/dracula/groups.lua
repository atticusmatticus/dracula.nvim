...
local function setup(configs)
   ...
   return {
      ...
      WinSeparator = { fg = colors.bright_green },
      ...
      SpellBad = { fg = colors.dim_white, underline = true },
      ...
      ["@keyword"] = { fg = colors.bright_magenta, bold = true },
      ...
      ["@markup.italic"] = { link = "@markup.emphasis" }, -- italic
      ["@markup.underline"] = { fg = colors.orange, underline = true },
      ...
      markdownH1 = { link = "rainbow1" }, -- { link = "rainbow1" },
      markdownH2 = { link = "rainbow2" }, -- { link = "rainbow2" },
      markdownH3 = { link = "rainbow3" }, -- { link = "rainbow3" },
      markdownH4 = { link = "rainbow4" }, -- { link = "rainbow4" },
      markdownH5 = { link = "rainbow5" }, -- { link = "rainbow5" },
      markdownH6 = { link = "rainbow6" }, -- { link = "rainbow6" },
      ...
      -- TS rainbow colors
      rainbowcol1 = { fg = colors.fg, bold = true }, -- { fg = colors.fg },
      rainbowcol2 = { fg = colors.pink }, -- { fg = colors.pink },
      rainbowcol3 = { fg = colors.cyan }, -- { fg = colors.cyan },
      rainbowcol4 = { fg = colors.green }, -- { fg = colors.green },
      rainbowcol5 = { fg = colors.purple }, -- { fg = colors.purple },
      rainbowcol6 = { fg = colors.orange }, -- { fg = colors.orange },
      rainbowcol7 = { fg = colors.fg }, -- { fg = colors.fg },
      ...
      SnacksPickerDir = { fg = colors.comment, italic = true },
